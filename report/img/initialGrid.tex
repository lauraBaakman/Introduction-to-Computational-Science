  ...
  \newcommand\numFreeRowsCols{3}
  {
    ...
    \foreach \x in {0,...,\numRowsCols}
      \foreach \y in {0,...,\numRowsCols} 
         ...
         \node [free]  (\x\y) at (1.5*\x,1.5*\y) {\freeParticle{\label}};} 
    ...
    % Draw upper row of fixed nodes
    {
      ...
      \foreach \x in {0,...,\numRowsCols}
      {
        \pgfmathtruncatemacro{\label}{\x}
          \node [fixed] (\x\y) [label=above:{\fixedParticle{\label}}] at (1.5*\x,1.5*\y) {};
          \draw (\x\y)--(\x\yi);
      }
    }
    ...
    % Draw lower row of fixed nodes
    {
      ...
      \foreach \x in {0,...,\numRowsCols}
      {
        ...
        \node [fixed] (\x\y) [label=below:{\fixedParticle{\label}}] at (1.5*\x,1.5*\y) {}; 
        \draw (\x\y)--(\x\yi);
      } 
    }
    ...
    % Draw left column of fixed nodes
    {
      ...
      \foreach \y in {0,...,\numRowsCols}
      {
        ...
        \node [fixed] (\x\y) [label=left:{\fixedParticle{\label}}] at (1.5*\x,1.5*\y) {}; 
        \draw (\x\y)--(\xi\y);
      } 
    }
    ...
    %Draw right column of fixed nodes
    {
      ...
      \foreach \y in {0,...,\numRowsCols}
      {
        ...
        \node [fixed] (\x\y) [label=right:{\fixedParticle{\label}}] at (1.5*\x,1.5*\y) {}; 
        \draw (\x\y)--(\xi\y);
      } 
    }    
