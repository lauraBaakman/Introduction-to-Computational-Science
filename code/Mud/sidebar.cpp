    ...
    ui(new Ui::Sidebar)
{
    ...
    on_springConstantStandardDeviation_valueChanged();
    on_springConstantMean_valueChanged();
}
...
void Sidebar::on_springConstantStandardDeviation_valueChanged()
{
    QString label;
...
void Sidebar::on_springConstantMean_valueChanged()
{
    QString label;
